...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Usage: kfit_2tss(tac, w, scant, blood, wblood, dk, pinit, lb, ub, psens, maxit, td)  
// Compile method: mex kfit_2tss_mex_omp.cpp kinlib.cpp CXXFLAGS="\$CXXFLAGS -fopenmp" LDFLAGS="\$LDFLAGS -fopenmp"
{ 
  int		i, j;
  ...
  km.num_vox = 1;
  km.scant = scant;
  km.tacfunc = kconv_2tss_tac;
  km.jacfunc = kconv_2tss_jac;
