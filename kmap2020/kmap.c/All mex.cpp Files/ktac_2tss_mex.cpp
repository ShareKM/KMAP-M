...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Usage: ktac_2tss(par, scant, blood, wblood, dk)      
//          
{   
  ...
  // voxel-wise 
  if (nlhs==1)
    kconv_2tss_tac(par, dk, scant, td, b, wb, num_frm, num_vox, c);
  else if (nlhs>1) 
    kconv_2tss_jac(par, dk, scant, td, b, wb, num_frm, num_vox, c, psens, s);
