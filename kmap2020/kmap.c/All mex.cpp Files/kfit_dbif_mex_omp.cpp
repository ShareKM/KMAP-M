...
// Compile method: mex kfit_dbif_mex_omp.cpp kinlib.cpp CXXFLAGS="\$CXXFLAGS -fopenmp" LDFLAGS="\$LDFLAGS -fopenmp"
...
{ 
  ...
  km.num_vox = 1;
  km.scant = scant;
  km.tacfunc = kconv_dbif_tac;
  km.jacfunc = kconv_dbif_jac;
