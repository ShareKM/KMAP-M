...
// Compile method: mex kfit_liver_mex_omp.cpp kinlib.cpp CXXFLAGS="\$CXXFLAGS -fopenmp" LDFLAGS="\$LDFLAGS -fopenmp"
// NOTE-June-03-2016: compile the file on master node of saturn of jupiter
{ 
  int		i, j;
  ...
  km.num_vox = 1;
  km.scant = scant;
  km.tacfunc = kconv_liver_tac;
  km.jacfunc = kconv_liver_jac;
