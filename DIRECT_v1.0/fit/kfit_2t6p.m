...
% initial kinetic parameters  [va vb K1 k2 k3 k4]'
if isempty(k0)
    k0 = [0.05 0.05 0.1 0.1 0.1 0.01];
end
if isvector(k0)
...
[k,cfit] = kfit_2t6p_mex_omp(ct, wt, scant, cp, cwb, dk, kinit, lb, ub, ...
                         ps, maxit, td);
