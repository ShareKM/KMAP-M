...
if nargout==2 & size(prm,2)==1
    [ct, st] = ktac_2tss_mex(prm, scant, cp, cwb, dk, td);
else
    ct = ktac_2tss_mex(prm, scant, cp, cwb, dk, td);
    st = [];
end
